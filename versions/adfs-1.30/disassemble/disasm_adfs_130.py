...
d.label(0x1117, 'wksp_current_drive', length=1, group='ram_workspace', access='rw', description="Current default drive, held as a drive ID: the drive number shifted left five places, so drives 0-3 are &00, &20, &40 and &60. close_all_drives walks them by subtracting &20 at [&A0DE](address:A0DE). &FF means no drive has been selected yet. Stored in this form so it can be ORed straight into the top bits of a disc address, where bits 5-6 carry the drive and bits 0-4 are sector-address bits 16-20.")
...
d.entry(0x8DED)
# DEL is a control character, so keep it as a byte; the five printable
# pathname metacharacters render as EQUS so the character itself is
# visible in the listing.
d.byte(0x8DED)
d.comment(0x8DED, 'DEL (&7F, control character)', align=Align.INLINE)
d.string(0x8DEE, 1)
...
d.string(0x8DF2, 1)
d.comment(0x8DF2, "Root directory specifier (synonym for '$')", align=Align.INLINE)
...
d.label(0xBA57, 'bput_get_drive_byte')

d.label(0xBA5F, 'bput_bad_drive_error')

d.label(0xBA63, 'bput_check_drive_valid')

d.label(0xBA72, 'bput_select_drive_1')

d.label(0xBA74, 'bput_store_drive_latch')
...
d.comment(0xBA57, 'Top sector-address byte: holds the drive', align=Align.INLINE)
d.comment(0xBA5B, 'Sector-address bits 16-20 must be clear', align=Align.INLINE)
d.comment(0xBA5D, 'Clear: address fits a floppy, carry on', align=Align.INLINE)
d.comment(0xBA65, 'Drive bit 6 set: drive 2 or 3, not on a 1770', align=Align.INLINE)
d.comment(0xBA6A, 'Drive bit 5: drive 1 rather than drive 0?', align=Align.INLINE)
d.comment(0xBA6E, 'Drive 0: latch value &21 (bit 0)', align=Align.INLINE)
d.comment(0xBA72, 'Drive 1: latch value &22 (bit 1)', align=Align.INLINE)
d.comment(0xBA74, 'Store in the drive-control latch shadow', align=Align.INLINE)
...
d.comment(0xB9E9, 'Write to Tube R3', align=Align.INLINE)
d.comment(0xB9EC, 'Always branch to advance', align=Align.INLINE)
d.comment(0xB9EE, 'Write file: read byte from Tube R3', align=Align.INLINE)
...
d.comment(0x8D8D, "Clear bit 1 to fold '&' onto '$'", align=Align.INLINE)
d.comment(0x8D8F, "Is it '$' or '&' (root)?", align=Align.INLINE)
...
d.comment(0xBD74, 'Scratch: copy destination high byte', align=Align.INLINE)
...
d.comment(0xBE29, 'Scratch: save the FDC command over the NMI wait', align=Align.INLINE)
d.comment(0xBE2B, 'Clear seek flag', align=Align.INLINE)
d.comment(0xBE2E, 'Recover the saved FDC command', align=Align.INLINE)
...
d.comment(0xBE7B, 'Recover the saved FDC command', align=Align.INLINE)
...
d.comment(0xBF01, 'Top byte of the disc address', align=Align.INLINE)
d.comment(0xBF03, 'Merge in the current drive ID (bits 5-6)', align=Align.INLINE)
d.comment(0xBF06, 'Scratch: hold the combined drive byte', align=Align.INLINE)
d.comment(0xBF08, 'Sector-address bits 16-20 must be clear', align=Align.INLINE)
d.comment(0xBF0A, 'Clear: address fits a floppy, carry on', align=Align.INLINE)
d.comment(0xBF0C, 'Error &61: bad address', align=Align.INLINE)
d.comment(0xBF0F, 'Test drive bit 6 into V', align=Align.INLINE)
d.comment(0xBF11, 'Clear: drive 0 or 1, go and select it', align=Align.INLINE)
d.comment(0xBF13, 'Drive 2 or 3: error &65, volume (drive) error', align=Align.INLINE)
d.comment(0xBF15, 'Store error code', align=Align.INLINE)
d.comment(0xBF17, 'Branch to floppy error', align=Align.INLINE)
d.comment(0xBF19, 'Get the drive byte back', align=Align.INLINE)
d.comment(0xBF1B, 'Bit 5: is it drive 1?', align=Align.INLINE)
d.comment(0xBF1D, 'Yes: select drive 1', align=Align.INLINE)
d.comment(0xBF1F, 'Drive 0: latch value &21 (bit 0)', align=Align.INLINE)
d.comment(0xBF21, 'Branch (always)', align=Align.INLINE)
d.comment(0xBF23, 'Drive 1: latch value &22 (bit 1)', align=Align.INLINE)
d.comment(0xBF25, 'Store in the drive-control latch shadow', align=Align.INLINE)
...
d.label(0xBF0F, 'rw_check_drive_reachable')

d.label(0xBF19, 'rw_select_drive')

d.label(0xBF23, 'rw_select_drive_1')

d.label(0xBF25, 'rw_store_drive_latch')
...
d.comment(0xBA5A, 'Save it for the drive tests', align=Align.INLINE)
d.comment(0xBA5F, 'Pop and discard', align=Align.INLINE)
d.comment(0xBA60, 'Error &61: bad address', align=Align.INLINE)
d.comment(0xBA63, 'Pop the drive byte', align=Align.INLINE)
d.comment(0xBA64, 'Re-push it for the drive-select test', align=Align.INLINE)
d.comment(0xBA67, 'Yes: reject it as a bad address', align=Align.INLINE)
d.comment(0xBA69, 'Pop the drive byte again', align=Align.INLINE)
d.comment(0xBA6C, 'Yes: select drive 1', align=Align.INLINE)
...
ADFS selects itself when no key is held, so RIGHT and A are
overrides rather than the usual route in: they keep ADFS
when a key is down that would otherwise reach the decline
at &9B64 and let another filing system take the call. The
key code is only ever compared against &43, so RIGHT and A
have identical effect - both preserve the boot flag and the
cached map and directory. That matters on a hard break with
no hard drive, where holding either one avoids the cache
invalidation the no-key path would perform.

Why the ROM accepts RIGHT as well as the mnemonic A is not
settled; nothing in the code distinguishes them.
