...
label(0x00B0, "zp_ctrl_blk")
label(0x00B1, "zp_ctrl_blk_h")
label(0x00B2, "zp_mem_ptr")
label(0x00B3, "zp_mem_ptr_h")
label(0x00B4, "zp_text_ptr")
label(0x00B5, "zp_text_ptr_h")
label(0x00B6, "zp_entry_ptr")
label(0x00B7, "zp_entry_ptr_h")
label(0x00B8, "zp_osfile_ptr")
label(0x00B9, "zp_osfile_ptr_h")
label(0x00BA, "zp_wksp_ptr")
label(0x00BB, "zp_wksp_ptr_h")
label(0x00BC, "zp_buf_src")
label(0x00BD, "zp_buf_src_h")
label(0x00BE, "zp_buf_dest")
label(0x00BF, "zp_buf_dest_h")

# Filing system persistent workspace (&C0-&CF)
label(0x00C0, "zp_name_ptr")
label(0x00C1, "zp_name_ptr_h")
label(0x00C2, "zp_save_y")
label(0x00C3, "zp_save_x")
label(0x00C4, "zp_osfind_y")
label(0x00C5, "zp_osfind_x")
label(0x00C6, "zp_gspb_ptr")
label(0x00C7, "zp_gspb_ptr_h")
