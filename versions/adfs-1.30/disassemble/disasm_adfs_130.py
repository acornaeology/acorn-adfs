...
d.comment(0x9A85, 'E.$.!BOOT (exec boot file)', align=Align.INLINE)
...
d.comment(0x9398, "' ' + bit 7: end of inline string", align=Align.INLINE)
...
d.comment(0x9FD8, "X=&30 ('0'): lowest ADFS file handle", align=Align.INLINE)
d.comment(0x9FDA, "Y=&39 ('9'): highest ADFS file handle", align=Align.INLINE)
d.comment(0x9FDC, 'Return to FSC dispatcher', align=Align.INLINE)
