...
# Format: ASCII name, dispatch_hi|&80, dispatch_lo, param_nibbles
string(0x9EE3, 6)
comment(0x9EE3, '"ACCESS" command name', inline=True)
byte(0x9EE9)
comment(0x9EE9, "Dispatch hi|&80: -> &993D", inline=True)
byte(0x9EEA)
comment(0x9EEA, "Dispatch lo", inline=True)
byte(0x9EEB)
comment(0x9EEB, "Params &16: <List Spec> (L)(W)(R)(E)", inline=True)
string(0x9EEC, 4)
comment(0x9EEC, '"BACK" command name', inline=True)
byte(0x9EF0)
comment(0x9EF0, "Dispatch hi|&80: -> &A497", inline=True)
byte(0x9EF1)
comment(0x9EF1, "Dispatch lo", inline=True)
byte(0x9EF2)
comment(0x9EF2, "Params &00: (none)", inline=True)
string(0x9EF3, 3)
comment(0x9EF3, '"BYE" command name', inline=True)
byte(0x9EF6)
comment(0x9EF6, "Dispatch hi|&80: -> &A0C3", inline=True)
byte(0x9EF7)
comment(0x9EF7, "Dispatch lo", inline=True)
byte(0x9EF8)
comment(0x9EF8, "Params &00: (none)", inline=True)
string(0x9EF9, 4)
comment(0x9EF9, '"CDIR" command name', inline=True)
byte(0x9EFD)
comment(0x9EFD, "Dispatch hi|&80: -> &9570", inline=True)
byte(0x9EFE)
comment(0x9EFE, "Dispatch lo", inline=True)
byte(0x9EFF)
comment(0x9EFF, "Params &20: <Ob Spec>", inline=True)
string(0x9F00, 5)
comment(0x9F00, '"CLOSE" command name', inline=True)
byte(0x9F05)
comment(0x9F05, "Dispatch hi|&80: -> &B1B3", inline=True)
byte(0x9F06)
comment(0x9F06, "Dispatch lo", inline=True)
byte(0x9F07)
comment(0x9F07, "Params &00: (none)", inline=True)
string(0x9F08, 7)
comment(0x9F08, '"COMPACT" command name', inline=True)
byte(0x9F0F)
comment(0x9F0F, "Dispatch hi|&80: -> &A276", inline=True)
byte(0x9F10)
comment(0x9F10, "Dispatch lo", inline=True)
byte(0x9F11)
comment(0x9F11, "Params &50: <SP> <LP>", inline=True)
string(0x9F12, 4)
comment(0x9F12, '"COPY" command name', inline=True)
byte(0x9F16)
comment(0x9F16, "Dispatch hi|&80: -> &A81D", inline=True)
byte(0x9F17)
comment(0x9F17, "Dispatch lo", inline=True)
byte(0x9F18)
comment(0x9F18, "Params &13: <List Spec> <*Ob Spec*>", inline=True)
string(0x9F19, 6)
comment(0x9F19, '"DELETE" command name', inline=True)
byte(0x9F1F)
comment(0x9F1F, "Dispatch hi|&80: -> &A0BB", inline=True)
byte(0x9F20)
comment(0x9F20, "Dispatch lo", inline=True)
byte(0x9F21)
comment(0x9F21, "Params &20: <Ob Spec>", inline=True)
string(0x9F22, 7)
comment(0x9F22, '"DESTROY" command name', inline=True)
byte(0x9F29)
comment(0x9F29, "Dispatch hi|&80: -> &99E6", inline=True)
byte(0x9F2A)
comment(0x9F2A, "Dispatch lo", inline=True)
byte(0x9F2B)
comment(0x9F2B, "Params &10: <List Spec>", inline=True)
string(0x9F2C, 3)
comment(0x9F2C, '"DIR" command name', inline=True)
byte(0x9F2F)
comment(0x9F2F, "Dispatch hi|&80: -> &953F", inline=True)
byte(0x9F30)
comment(0x9F30, "Dispatch lo", inline=True)
byte(0x9F31)
comment(0x9F31, "Params &20: <Ob Spec>", inline=True)
string(0x9F32, 8)
comment(0x9F32, '"DISMOUNT" command name', inline=True)
byte(0x9F3A)
comment(0x9F3A, "Dispatch hi|&80: -> &A111", inline=True)
byte(0x9F3B)
comment(0x9F3B, "Dispatch lo", inline=True)
byte(0x9F3C)
comment(0x9F3C, "Params &40: (<Drive>)", inline=True)
string(0x9F3D, 2)
comment(0x9F3D, '"EX" command name', inline=True)
byte(0x9F3F)
comment(0x9F3F, "Dispatch hi|&80: -> &9433", inline=True)
byte(0x9F40)
comment(0x9F40, "Dispatch lo", inline=True)
byte(0x9F41)
comment(0x9F41, "Params &30: <*Ob Spec*>", inline=True)
string(0x9F42, 4)
comment(0x9F42, '"FREE" command name', inline=True)
byte(0x9F46)
comment(0x9F46, "Dispatch hi|&80: -> &A01B", inline=True)
byte(0x9F47)
comment(0x9F47, "Dispatch lo", inline=True)
byte(0x9F48)
comment(0x9F48, "Params &00: (none)", inline=True)
string(0x9F49, 4)
comment(0x9F49, '"INFO" command name', inline=True)
byte(0x9F4D)
comment(0x9F4D, "Dispatch hi|&80: -> &94E7", inline=True)
byte(0x9F4E)
comment(0x9F4E, "Dispatch lo", inline=True)
byte(0x9F4F)
comment(0x9F4F, "Params &10: <List Spec>", inline=True)
string(0x9F50, 4)
comment(0x9F50, '"LCAT" command name', inline=True)
byte(0x9F54)
comment(0x9F54, "Dispatch hi|&80: -> &A47F", inline=True)
byte(0x9F55)
comment(0x9F55, "Dispatch lo", inline=True)
byte(0x9F56)
comment(0x9F56, "Params &00: (none)", inline=True)
string(0x9F57, 3)
comment(0x9F57, '"LEX" command name', inline=True)
byte(0x9F5A)
comment(0x9F5A, "Dispatch hi|&80: -> &A48B", inline=True)
byte(0x9F5B)
comment(0x9F5B, "Dispatch lo", inline=True)
byte(0x9F5C)
comment(0x9F5C, "Params &00: (none)", inline=True)
string(0x9F5D, 3)
comment(0x9F5D, '"LIB" command name', inline=True)
byte(0x9F60)
comment(0x9F60, "Dispatch hi|&80: -> &A444", inline=True)
byte(0x9F61)
comment(0x9F61, "Dispatch lo", inline=True)
byte(0x9F62)
comment(0x9F62, "Params &30: <*Ob Spec*>", inline=True)
string(0x9F63, 3)
comment(0x9F63, '"MAP" command name', inline=True)
byte(0x9F66)
comment(0x9F66, "Dispatch hi|&80: -> &A04A", inline=True)
byte(0x9F67)
comment(0x9F67, "Dispatch lo", inline=True)
byte(0x9F68)
comment(0x9F68, "Params &00: (none)", inline=True)
string(0x9F69, 5)
comment(0x9F69, '"MOUNT" command name', inline=True)
byte(0x9F6E)
comment(0x9F6E, "Dispatch hi|&80: -> &A15E", inline=True)
byte(0x9F6F)
comment(0x9F6F, "Dispatch lo", inline=True)
byte(0x9F70)
comment(0x9F70, "Params &40: (<Drive>)", inline=True)
string(0x9F71, 6)
comment(0x9F71, '"REMOVE" command name', inline=True)
byte(0x9F77)
comment(0x9F77, "Dispatch hi|&80: -> &9109", inline=True)
byte(0x9F78)
comment(0x9F78, "Dispatch lo", inline=True)
byte(0x9F79)
comment(0x9F79, "Params &20: <Ob Spec>", inline=True)
string(0x9F7A, 6)
comment(0x9F7A, '"RENAME" command name', inline=True)
byte(0x9F80)
comment(0x9F80, "Dispatch hi|&80: -> &A503", inline=True)
byte(0x9F81)
comment(0x9F81, "Dispatch lo", inline=True)
byte(0x9F82)
comment(0x9F82, "Params &22: <Ob Spec> <Ob Spec>", inline=True)
string(0x9F83, 5)
comment(0x9F83, '"TITLE" command name', inline=True)
byte(0x9F88)
comment(0x9F88, "Dispatch hi|&80: -> &A252", inline=True)
byte(0x9F89)
comment(0x9F89, "Dispatch lo", inline=True)
byte(0x9F8A)
comment(0x9F8A, "Params &70: <Title>", inline=True)
# Bytes &9F8B-&9F8C are the final entry's sentinel/terminator
byte(0x9F8B)
comment(0x9F8B, "End: hi|&80 -> &A399 (*RUN handler)", inline=True)
byte(0x9F8C)
comment(0x9F8C, "End: lo (used for *RUN dispatch)", inline=True)
...
comment(0xA04A, 'Print column header', inline=True)
