...
entry(0x9CB3)
byte(0x9CB3)
comment(0x9CB3, "FILEV low:  &1B -> &FF1B (OSFILE)", inline=True)
byte(0x9CB4)
comment(0x9CB4, "FILEV high: &FF (extended vector)", inline=True)
byte(0x9CB5)
comment(0x9CB5, "ARGSV low:  &1E -> &FF1E (OSARGS)", inline=True)
byte(0x9CB6)
comment(0x9CB6, "ARGSV high: &FF", inline=True)
byte(0x9CB7)
comment(0x9CB7, "BGETV low:  &21 -> &FF21 (OSBGET)", inline=True)
byte(0x9CB8)
comment(0x9CB8, "BGETV high: &FF", inline=True)
byte(0x9CB9)
comment(0x9CB9, "BPUTV low:  &24 -> &FF24 (OSBPUT)", inline=True)
byte(0x9CBA)
comment(0x9CBA, "BPUTV high: &FF", inline=True)
byte(0x9CBB)
comment(0x9CBB, "GBPBV low:  &27 -> &FF27 (OSGBPB)", inline=True)
byte(0x9CBC)
comment(0x9CBC, "GBPBV high: &FF", inline=True)
byte(0x9CBD)
comment(0x9CBD, "FINDV low:  &2A -> &FF2A (OSFIND)", inline=True)
byte(0x9CBE)
comment(0x9CBE, "FINDV high: &FF", inline=True)
byte(0x9CBF)
comment(0x9CBF, "FSCV low:   &2D -> &FF2D (FSC)", inline=True)
byte(0x9CC0)
comment(0x9CC0, "FSCV high:  &FF", inline=True)
entry(0x9CC1)
entry(0x9CD6)
entry(0x9E6D)
entry(0x9EE3)
