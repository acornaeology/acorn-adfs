...
hook_subroutine(0x832B, "sub_c832b", brk_error_hook)  # falls through to &8348
...
comment(0x814D, "X=&27, Y=&10: Tube workspace addr", inline=True)
...
comment(0x81EA, "X=&27, Y=&10: Tube workspace address", inline=True)
...
comment(0x81FC, "X=&27, Y=&10: Tube workspace address", inline=True)
...
comment(0x8483, "Call sub_ca149 twice", inline=True)
...
comment(0x924A, "X = A*2 + 2 (skip first pair)", inline=True)
...
comment(0xBF59, "Sector mid >= &0A (>= &0A00)?", inline=True)
...
comment(0xBA00, "JMP to main floppy command handler", inline=True)
comment(0xBA03, "JMP to partial sector buffer op", inline=True)
comment(0xBA06, "JMP to floppy write BPUT sector", inline=True)
comment(0xBA09, "JMP to floppy read BPUT sector", inline=True)
...
comment(0xB6BC, "Add byte count to base address", inline=True)
comment(0xB6CD, "Clear carry for address calc", inline=True)
comment(0xB6ED, "Rotate direction flag", inline=True)
comment(0xB6FB, "X=2: scan channel ensure table", inline=True)
comment(0xB702, "Non-zero: not this channel", inline=True)
comment(0xB705, "Loop for channels", inline=True)
comment(0xB71B, "Restore control block pointer", inline=True)
comment(0xB71F, "Return", inline=True)
comment(0xB723, "A=0: clear EOF flag", inline=True)
comment(0xB72C, "Clear carry", inline=True)
comment(0xB75A, "Next byte position", inline=True)
comment(0xB76B, "A=1: decrement count by 1", inline=True)
comment(0xB770, "Y=3: 4-byte count decrement", inline=True)
comment(0xB778, "Decrement Y", inline=True)
comment(0xB780, "A=2: Tube transfer direction", inline=True)
comment(0xB783, "Rotate into position", inline=True)
comment(0xB78B, "Compare with 1", inline=True)
comment(0xB7AD, "Next byte (decreasing Y)", inline=True)
comment(0xB7BC, "Clear carry for address calc", inline=True)
comment(0xB7EB, "Get channel index", inline=True)
comment(0xB837, "Save flags before count check", inline=True)
comment(0xB83E, "OR with &40 flag", inline=True)
comment(0xB846, "Y=&10: workspace page", inline=True)
comment(0xB84E, "Store buffer pointer high", inline=True)
comment(0xB85A, "Return", inline=True)
comment(0xB865, "Restore Y from buffer pointer", inline=True)
comment(0xB87C, "Next byte", inline=True)
comment(0xB883, "Compare with &21 (printable)", inline=True)
comment(0xB88F, "Return", inline=True)
comment(0xB892, "Transfer to Y", inline=True)
comment(0xB898, "Decrement Y", inline=True)
comment(0xB8A6, "Next byte in title", inline=True)
comment(0xB8B2, "Loop for title bytes", inline=True)
comment(0xB8B8, "Y=&FF: init for loop", inline=True)
comment(0xB8C7, "Compared all 19 title bytes?", inline=True)
comment(0xB8C9, "No: continue", inline=True)
comment(0xB8D4, "Shift drive bits to low position", inline=True)
comment(0xB8D5, "Second shift", inline=True)
comment(0xB8D7, "Third shift", inline=True)
comment(0xB8F5, "Store address high byte", inline=True)
comment(0xB8FA, "Bit 7: Tube active, skip direct", inline=True)
comment(0xB8FD, "Rotate flag bit", inline=True)
comment(0xB8FF, "Continue rotation", inline=True)
comment(0xB908, "A=1: length of drive string", inline=True)
comment(0xB923, "Y=0: clear for search", inline=True)
comment(0xB933, "Zero: loop done", inline=True)
comment(0xB937, "Get byte count from control block", inline=True)
comment(0xB93F, "Transfer to X", inline=True)
comment(0xB945, "Decrement name counter", inline=True)
comment(0xB948, "Add &1A to advance past entry", inline=True)
comment(0xB94D, "Clear carry for pointer advance", inline=True)
comment(0xB95B, "Z: no more entries in block", inline=True)
comment(0xB960, "Get filename pointer low", inline=True)
comment(0xB963, "Add &1A (entry size)", inline=True)
comment(0xB975, "Store result in control block", inline=True)
comment(0xB989, "Save flags", inline=True)
comment(0xB9AD, "Rotate bit into position", inline=True)
comment(0xB9CF, "Restore flags", inline=True)
comment(0xB9E0, "C clear: no more entries", inline=True)

# Byte transfer loop - copies bytes via OSBGET/OSBPUT
comment(0xB6B9, "Get memory address from block", inline=True)
comment(0xB6BB, "Add to transfer base address", inline=True)
comment(0xB6BE, "Store updated address", inline=True)
comment(0xB6C0, "Next byte", inline=True)
comment(0xB6C1, "Next address byte", inline=True)
comment(0xB6C2, "Loop for 4 bytes", inline=True)
comment(0xB6C4, "Get memory addr byte 3 (high)", inline=True)
comment(0xB6C7, "OR with byte 4", inline=True)
comment(0xB6CA, "Non-zero: Tube address", inline=True)
comment(0xB6CC, "Get byte 3 again", inline=True)
comment(0xB6CF, "Compare with &FE (I/O space)", inline=True)
comment(0xB6D1, "Below &FE: Tube transfer", inline=True)
comment(0xB6D3, "Get byte 4", inline=True)
comment(0xB6D6, "Is it &FF (host memory)?", inline=True)
comment(0xB6D8, "Yes: direct memory transfer", inline=True)
comment(0xB6DA, "Tube: set up Tube transfer path", inline=True)
comment(0xB6DD, "Get function code", inline=True)
comment(0xB6E0, "Bit 1 set: read (odd function)", inline=True)
comment(0xB6E2, "A=0: Tube write direction", inline=True)
comment(0xB6E4, "Set Tube transfer mode", inline=True)
comment(0xB6E6, "Tube read: A=1", inline=True)
comment(0xB6E8, "Set Tube direction flag", inline=True)
comment(0xB6EA, "X=&B7: Tube workspace ptr", inline=True)
comment(0xB6EC, "Y=&10: Tube workspace page", inline=True)
comment(0xB6EE, "jsr sub_cabd8", inline=True)
comment(0xB6F1, "ldx zp_channel_offset", inline=True)
comment(0xB6F3, "lda l10b4", inline=True)
comment(0xB6F6, "and #2", inline=True)
comment(0xB6F8, "beq cb704", inline=True)
comment(0xB6FA, "lda wksp_ch_flags,x", inline=True)
comment(0xB6FD, "and #4", inline=True)
comment(0xB6FF, "bne cb722", inline=True)
comment(0xB701, "jmp loop_cb70f", inline=True)
comment(0xB704, "lda wksp_ch_flags,x", inline=True)
comment(0xB707, "bpl loop_cb70f", inline=True)
comment(0xB709, "lda l103c", inline=True)
comment(0xB70C, "jmp cb712", inline=True)
comment(0xB70F, "ldx zp_channel_offset", inline=True)
comment(0xB711, "pla ", inline=True)
comment(0xB712, "ldy zp_save_y", inline=True)
comment(0xB714, "jsr my_osbput", inline=True)
comment(0xB717, "lda l103f", inline=True)
comment(0xB71A, "ora l103e", inline=True)
comment(0xB71D, "ora l103d", inline=True)
comment(0xB720, "bne cb726", inline=True)
comment(0xB722, "lda l103c", inline=True)
comment(0xB725, "beq cb74e", inline=True)
comment(0xB726, "lda l10b4", inline=True)
comment(0xB729, "and #2", inline=True)
comment(0xB72B, "beq cb73e", inline=True)
comment(0xB72D, "ldy zp_save_y", inline=True)
comment(0xB72F, "jsr my_osbget", inline=True)
comment(0xB732, "bcc cb73a", inline=True)
comment(0xB734, "lda #0", inline=True)
comment(0xB736, "sta l10b5", inline=True)
comment(0xB738, "bcc cb74e", inline=True)
comment(0xB73A, "bit zp_flags", inline=True)
comment(0xB73C, "bvs cb744", inline=True)
comment(0xB73E, "ldy #0", inline=True)
comment(0xB740, "sta (l10b7),y", inline=True)
comment(0xB742, "bvc cb746", inline=True)
comment(0xB744, "sta tube_data_register_3", inline=True)
comment(0xB747, "inc l10b7", inline=True)
comment(0xB74A, "bne cb726", inline=True)
comment(0xB74C, "inc l10b8", inline=True)
comment(0xB74E, "lda l10b4", inline=True)
comment(0xB751, "and #2", inline=True)
comment(0xB753, "bne cb769", inline=True)
comment(0xB755, "bit zp_flags", inline=True)
comment(0xB757, "bvs cb762", inline=True)
comment(0xB759, "ldy #0", inline=True)
comment(0xB75B, "lda (l10b7),y", inline=True)
comment(0xB75D, "pha ", inline=True)
comment(0xB75E, "inc l10b7", inline=True)
comment(0xB761, "bne cb709", inline=True)
comment(0xB762, "lda tube_data_register_3", inline=True)
comment(0xB765, "pha ", inline=True)
comment(0xB766, "inc l10b7", inline=True)
comment(0xB769, "sec ", inline=True)
comment(0xB76A, "lda l103c", inline=True)
comment(0xB76D, "sbc #1", inline=True)
comment(0xB76F, "sta l103c", inline=True)
comment(0xB772, "bcs loop_cb726", inline=True)
comment(0xB774, "lda l103d", inline=True)
comment(0xB777, "bne cb77c", inline=True)
comment(0xB779, "dec l103e", inline=True)
comment(0xB77C, "dec l103d", inline=True)
comment(0xB77F, "lda l103f", inline=True)
comment(0xB782, "sbc #0", inline=True)
comment(0xB784, "sta l103f", inline=True)
comment(0xB787, "jmp loop_cb726", inline=True)
comment(0xB78A, "jsr release_tube", inline=True)
comment(0xB78D, "ldy #5", inline=True)
comment(0xB78F, "ldx #3", inline=True)
comment(0xB791, "clc ", inline=True)
comment(0xB792, "lda (zp_c6),y", inline=True)
comment(0xB794, "adc l103b,y", inline=True)
comment(0xB797, "sta (zp_c6),y", inline=True)
comment(0xB799, "iny ", inline=True)
comment(0xB79A, "dex ", inline=True)
comment(0xB79B, "bpl loop_cb792", inline=True)
comment(0xB79D, "ldy #1", inline=True)
comment(0xB79F, "ldx #3", inline=True)
comment(0xB7A1, "sec ", inline=True)
comment(0xB7A2, "lda l10b7,y", inline=True)
comment(0xB7A5, "sbc zp_save_x,y", inline=True)
comment(0xB7A8, "sta (zp_c6),y", inline=True)
comment(0xB7AA, "iny ", inline=True)
comment(0xB7AB, "dex ", inline=True)
comment(0xB7AC, "bpl loop_cb7a2", inline=True)
comment(0xB7AE, "lda l10b5", inline=True)
comment(0xB7B1, "beq cb7b8", inline=True)
comment(0xB7B3, "lda zp_flags", inline=True)
comment(0xB7B5, "and #&fb", inline=True)
comment(0xB7B7, "sta zp_flags", inline=True)
comment(0xB7B8, "jsr c89d3", inline=True)
comment(0xB7BB, "ldx zp_c6", inline=True)
comment(0xB7BD, "ldy zp_c7", inline=True)
comment(0xB7BF, "lda #0", inline=True)
comment(0xB7C1, "rts ", inline=True)

# Direct memory byte transfer (no Tube)
comment(0xB7C2, "ldy #1", inline=True)
comment(0xB7C4, "ldx #3", inline=True)
comment(0xB7C6, "lda (zp_c6),y", inline=True)
comment(0xB7C8, "sta zp_b2,x", inline=True)
comment(0xB7CA, "iny ", inline=True)
comment(0xB7CB, "dex ", inline=True)
comment(0xB7CC, "bpl loop_cb7c6", inline=True)
comment(0xB7CE, "bit zp_flags", inline=True)
comment(0xB7D0, "bvc cb802", inline=True)
comment(0xB7D2, "lda l10b4", inline=True)
comment(0xB7D5, "and #2", inline=True)
comment(0xB7D7, "beq cb7f3", inline=True)
comment(0xB7D9, "ldx zp_channel_offset", inline=True)
comment(0xB7DB, "lda wksp_ch_flags,x", inline=True)
comment(0xB7DE, "and #4", inline=True)
comment(0xB7E0, "bne cb7ea", inline=True)
comment(0xB7E2, "ldy zp_save_y", inline=True)
comment(0xB7E4, "jsr my_osbget", inline=True)
comment(0xB7E7, "bcc cb7ed", inline=True)
comment(0xB7EA, "jmp cb78a", inline=True)
comment(0xB7ED, "sta tube_data_register_3", inline=True)
comment(0xB7F0, "jmp loop_cb822", inline=True)
comment(0xB7F3, "lda tube_data_register_3", inline=True)
comment(0xB7F6, "ldy zp_save_y", inline=True)
comment(0xB7F8, "ldx zp_channel_offset", inline=True)
comment(0xB7FA, "jsr my_osbput", inline=True)
comment(0xB7FD, "ldx zp_channel_offset", inline=True)
comment(0xB7FF, "jmp loop_cb822", inline=True)
comment(0xB802, "lda l10b4", inline=True)
comment(0xB805, "and #2", inline=True)
comment(0xB807, "beq cb81e", inline=True)
comment(0xB809, "ldx zp_channel_offset", inline=True)
comment(0xB80B, "lda wksp_ch_flags,x", inline=True)
comment(0xB80E, "and #4", inline=True)
comment(0xB810, "bne cb7ea", inline=True)
comment(0xB812, "ldy zp_save_y", inline=True)
comment(0xB814, "jsr my_osbget", inline=True)
comment(0xB817, "bcc cb81a", inline=True)
comment(0xB819, "beq cb7ea", inline=True)
comment(0xB81A, "ldy #0", inline=True)
comment(0xB81C, "sta (zp_b2),y", inline=True)
comment(0xB81E, "ldy #0", inline=True)
comment(0xB820, "lda (zp_b2),y", inline=True)
comment(0xB822, "ldy zp_save_y", inline=True)
comment(0xB824, "ldx zp_channel_offset", inline=True)
comment(0xB825, "jsr my_osbput", inline=True)
comment(0xB828, "inc zp_b2", inline=True)
comment(0xB82A, "bne cb832", inline=True)
comment(0xB82C, "inc zp_b3", inline=True)
comment(0xB82E, "bne cb832", inline=True)
comment(0xB830, "inc zp_b4", inline=True)
comment(0xB832, "sec ", inline=True)
comment(0xB833, "lda l103c", inline=True)
comment(0xB836, "sbc #1", inline=True)
comment(0xB838, "sta l103c", inline=True)
comment(0xB83B, "bcs loop_cb802", inline=True)
comment(0xB83D, "lda l103d", inline=True)
comment(0xB840, "bne cb845", inline=True)
comment(0xB842, "dec l103e", inline=True)
comment(0xB845, "dec l103d", inline=True)
comment(0xB848, "lda l103f", inline=True)
comment(0xB84B, "sbc #0", inline=True)
comment(0xB84D, "sta l103f", inline=True)
comment(0xB850, "ora l103e", inline=True)
comment(0xB853, "ora l103d", inline=True)
comment(0xB856, "ora l103c", inline=True)
comment(0xB859, "bne loop_cb802", inline=True)
comment(0xB85B, "jmp cb78a", inline=True)

# OSGBPB A=5-8: directory info reading (&B890)
comment(0xB85E, "ldy #1", inline=True)
comment(0xB860, "ldx #3", inline=True)
comment(0xB862, "lda (zp_c6),y", inline=True)
comment(0xB864, "sta l10b7,y", inline=True)
comment(0xB867, "iny ", inline=True)
comment(0xB868, "dex ", inline=True)
comment(0xB869, "bpl loop_cb862", inline=True)
comment(0xB86B, "ldy zp_c6", inline=True)
comment(0xB86D, "ldx zp_c7", inline=True)
comment(0xB86F, "lda #0", inline=True)
comment(0xB871, "rts ", inline=True)
comment(0xB872, "lda zp_flags", inline=True)
comment(0xB874, "and #&40", inline=True)
comment(0xB876, "lsr ", inline=True)
comment(0xB877, "lsr ", inline=True)
comment(0xB878, "lsr ", inline=True)
comment(0xB879, "lsr ", inline=True)
comment(0xB87A, "lsr ", inline=True)
comment(0xB87B, "eor #1", inline=True)
comment(0xB87D, "sta l10bd", inline=True)
comment(0xB880, "ldy #0", inline=True)
comment(0xB882, "ldx l10b7", inline=True)
comment(0xB885, "lda l10b8", inline=True)
comment(0xB888, "stx zp_b2", inline=True)
comment(0xB88A, "sta zp_b3", inline=True)
comment(0xB88C, "bit zp_flags", inline=True)
comment(0xB88E, "bvs cb8a1", inline=True)

# A=5-8 dispatch (&B890)
comment(0xB890, "lda l10b4", inline=True)
comment(0xB893, "cmp #8", inline=True)
comment(0xB895, "beq cb950", inline=True)
comment(0xB897, "cmp #7", inline=True)
comment(0xB899, "beq cb8d6", inline=True)
comment(0xB89B, "cmp #6", inline=True)
comment(0xB89D, "beq cb8cc", inline=True)
comment(0xB89F, "bne cb8a3", inline=True)
comment(0xB8A1, "jmp cb85e", inline=True)

# A=5: read directory title, boot option, drive
comment(0xB8A3, "lda #&13", inline=True)
comment(0xB8A5, "jsr sub_cb8fc", inline=True)
comment(0xB8A8, "ldx #0", inline=True)
comment(0xB8AA, "ldy #&d9", inline=True)
comment(0xB8AC, "lda #&16", inline=True)
comment(0xB8AE, "jsr sub_cb925", inline=True)
comment(0xB8B1, "lda fsm_s1_boot_option", inline=True)
comment(0xB8B4, "jsr sub_cb8fc", inline=True)
comment(0xB8B7, "lda wksp_current_drive", inline=True)
comment(0xB8BA, "asl ", inline=True)
comment(0xB8BB, "rol ", inline=True)
comment(0xB8BC, "rol ", inline=True)
comment(0xB8BD, "rol ", inline=True)
comment(0xB8BE, "ora #&30", inline=True)
comment(0xB8C0, "jsr sub_cb8fc", inline=True)
comment(0xB8C3, "ldx #0", inline=True)
comment(0xB8C5, "jmp cb85e", inline=True)

# A=6: read CSD name
comment(0xB8CC, "lda wksp_current_drive", inline=True)
comment(0xB8CF, "ldy #0", inline=True)
comment(0xB8D1, "ldx #&11", inline=True)
comment(0xB8D3, "jmp cb8e2", inline=True)

# A=7: read library name
comment(0xB8D6, "lda l111b", inline=True)
comment(0xB8D9, "ldy #&0a", inline=True)
comment(0xB8DB, "ldx #&11", inline=True)
comment(0xB8DD, "cmp #&ff", inline=True)
comment(0xB8DF, "beq cb8f7", inline=True)
comment(0xB8E2, "asl ", inline=True)
comment(0xB8E3, "rol ", inline=True)
comment(0xB8E4, "rol ", inline=True)
comment(0xB8E5, "rol ", inline=True)
comment(0xB8E6, "pha ", inline=True)
comment(0xB8E7, "lda #1", inline=True)
comment(0xB8E9, "jsr sub_cb8fc", inline=True)
comment(0xB8EC, "pla ", inline=True)
comment(0xB8ED, "ora #&30", inline=True)
comment(0xB8EF, "jsr sub_cb8fc", inline=True)
comment(0xB8F2, "lda #&0a", inline=True)
comment(0xB8F4, "jmp cb907", inline=True)
comment(0xB8F7, "ldx #0", inline=True)
comment(0xB8F9, "jmp cb85e", inline=True)

# sub_cb8fc - store byte in output buffer
comment(0xB8FC, "bit zp_flags", inline=True)
comment(0xB8FE, "bvs cb904", inline=True)
comment(0xB900, "sta (zp_b2),y", inline=True)
comment(0xB902, "bvc cb906", inline=True)
comment(0xB904, "sta tube_data_register_3", inline=True)
comment(0xB907, "jsr sub_cb8fc", inline=True)
comment(0xB90A, "sty l10be", inline=True)
comment(0xB90D, "clc ", inline=True)
comment(0xB90E, "adc zp_b2", inline=True)
comment(0xB910, "sta zp_b2", inline=True)
comment(0xB912, "bcc cb916", inline=True)
comment(0xB914, "inc zp_b3", inline=True)
comment(0xB916, "ldx #&cc", inline=True)
comment(0xB918, "lda #&16", inline=True)
comment(0xB91A, "stx zp_b6", inline=True)
comment(0xB91C, "sta zp_b7", inline=True)
comment(0xB91E, "ldy #0", inline=True)
comment(0xB920, "lda (zp_b6),y", inline=True)
comment(0xB922, "beq cb942", inline=True)
comment(0xB925, "and #&7f", inline=True)
comment(0xB927, "cmp #&20", inline=True)
comment(0xB929, "bcc cb935", inline=True)
comment(0xB92B, "inx ", inline=True)
comment(0xB92C, "iny ", inline=True)
comment(0xB92D, "cpy #&0a", inline=True)
comment(0xB92F, "bne loop_cb920", inline=True)
comment(0xB931, "txa ", inline=True)
comment(0xB932, "jmp cb93c", inline=True)
comment(0xB935, "txa ", inline=True)
comment(0xB936, "jsr sub_cb8fc", inline=True)
comment(0xB939, "ldy l10be", inline=True)
comment(0xB93C, "lda (zp_b6),y", inline=True)
comment(0xB93E, "and #&7f", inline=True)
comment(0xB940, "bne loop_cb936", inline=True)
comment(0xB942, "iny ", inline=True)
comment(0xB943, "sty l10be", inline=True)
comment(0xB946, "clc ", inline=True)
comment(0xB947, "lda l10be", inline=True)
comment(0xB94A, "adc zp_b2", inline=True)
comment(0xB94C, "sta zp_b2", inline=True)
comment(0xB94E, "bcc cb85e", inline=True)

# A=8: read filenames from CSD (&B950)
comment(0xB950, "ldy #0", inline=True)
comment(0xB952, "lda (zp_c6),y", inline=True)
comment(0xB954, "sta l10be", inline=True)
comment(0xB957, "sty wksp_disc_op_result", inline=True)
comment(0xB95A, "jsr verify_dir_integrity", inline=True)
comment(0xB95D, "ldy #9", inline=True)
comment(0xB95F, "lda dir_master_sequence", inline=True)
comment(0xB962, "cmp l10be", inline=True)
comment(0xB965, "beq cb970", inline=True)
comment(0xB967, "lda #0", inline=True)
comment(0xB969, "sta (zp_c6),y", inline=True)
comment(0xB96B, "sta wksp_disc_op_result", inline=True)
comment(0xB96E, "beq cb974", inline=True)
comment(0xB970, "lda (zp_c6),y", inline=True)
comment(0xB972, "sta wksp_disc_op_result", inline=True)
comment(0xB974, "ldy wksp_disc_op_result", inline=True)
comment(0xB977, "beq cb9a3", inline=True)
comment(0xB979, "lda #&05", inline=True)
comment(0xB97B, "sta zp_b6", inline=True)
comment(0xB97D, "lda #&12", inline=True)
comment(0xB97F, "sta zp_b7", inline=True)
comment(0xB981, "lda (zp_b6),y", inline=True)
comment(0xB983, "beq cb9a3", inline=True)
comment(0xB985, "lda zp_b6", inline=True)
comment(0xB987, "clc ", inline=True)
comment(0xB988, "adc #&1a", inline=True)
comment(0xB98A, "sta zp_b6", inline=True)
comment(0xB98C, "bcc cb990", inline=True)
comment(0xB98E, "inc zp_b7", inline=True)
comment(0xB990, "inc wksp_disc_op_result", inline=True)
comment(0xB993, "dey ", inline=True)
comment(0xB994, "bne loop_cb981", inline=True)
comment(0xB996, "ldx #5", inline=True)
comment(0xB998, "lda (zp_c6),y", inline=True)
comment(0xB99A, "beq cb9a3", inline=True)
comment(0xB99C, "lda (zp_b6),y", inline=True)
comment(0xB99E, "beq cb9aa", inline=True)
comment(0xB9A0, "dex ", inline=True)
comment(0xB9A1, "bne loop_cb998", inline=True)
comment(0xB9A3, "lda dir_master_sequence", inline=True)
comment(0xB9A6, "ldy #0", inline=True)
comment(0xB9A8, "sta (zp_c6),y", inline=True)
comment(0xB9AA, "lda #&0a", inline=True)
comment(0xB9AC, "jsr sub_cb8fc", inline=True)
comment(0xB9AF, "ldy #0", inline=True)
comment(0xB9B1, "lda (zp_b6),y", inline=True)
comment(0xB9B3, "and #&7f", inline=True)
comment(0xB9B5, "cmp #&0d", inline=True)
comment(0xB9B7, "beq cb9bf", inline=True)
comment(0xB9B9, "jsr sub_cb8fc", inline=True)
comment(0xB9BC, "iny ", inline=True)
comment(0xB9BD, "bne loop_cb9b1", inline=True)
comment(0xB9BF, "tya ", inline=True)
comment(0xB9C0, "clc ", inline=True)
comment(0xB9C1, "adc zp_b2", inline=True)
comment(0xB9C3, "sta zp_b2", inline=True)
comment(0xB9C5, "bcc cb9c9", inline=True)
comment(0xB9C7, "inc zp_b3", inline=True)
comment(0xB9C9, "lda #&0d", inline=True)
comment(0xB9CB, "jsr sub_cb8fc", inline=True)
comment(0xB9CE, "inc zp_b2", inline=True)
comment(0xB9D0, "bne cb9d4", inline=True)
comment(0xB9D2, "inc zp_b3", inline=True)
comment(0xB9D4, "clc ", inline=True)
comment(0xB9D5, "lda zp_b6", inline=True)
comment(0xB9D7, "adc #&1a", inline=True)
comment(0xB9D9, "sta zp_b6", inline=True)
comment(0xB9DB, "bcc cb9df", inline=True)
comment(0xB9DD, "inc zp_b7", inline=True)
comment(0xB9DF, "inc wksp_disc_op_result", inline=True)
comment(0xB9E2, "jsr tube_delay2", inline=True)
comment(0xB9E5, "ldy #0", inline=True)
comment(0xB9E7, "sty l10be", inline=True)
comment(0xB9EA, "lda (zp_b6),y", inline=True)
comment(0xB9EC, "bne cb9f3", inline=True)
comment(0xB9EE, "sty wksp_disc_op_result", inline=True)
comment(0xB9F1, "beq cb9fc", inline=True)
comment(0xB9F3, "sec ", inline=True)
comment(0xB9F4, "ldy #5", inline=True)
comment(0xB9F6, "lda (zp_c6),y", inline=True)
comment(0xB9F8, "sbc #1", inline=True)
comment(0xB9FA, "sta (zp_c6),y", inline=True)
comment(0xB9FC, "ldy #9", inline=True)
comment(0xB9FE, "lda wksp_disc_op_result", inline=True)
comment(0xB906, "iny ", inline=True)
comment(0xBA01, "sta (zp_c6),y", inline=True)
comment(0xBA03, "jmp loop_cb996", inline=True)
...
comment(0xB0C2, "Calculate next PTR position", inline=True)
...
comment(0x922B, "Check if at end of entries (addr &16BB)", inline=True)
...
comment(0x8DFB, "Y=0: search for empty slot", inline=True)
...
comment(0x8E8B, "Y=9: copy 10-byte filename", inline=True)
...
comment(0x8F58, "Y=&15: get OSFILE data bytes", inline=True)
...
comment(0x8B39, "Transfer to A", inline=True)
...
comment(0x9459, "'^': point to dir footer at &16C0", inline=True)
...
comment(0x9D1B, "A=0, Y=0 for OSARGS", inline=True)
...
comment(0x9AC3, "Push dispatch address low byte", inline=True)
comment(0x9AC7, "Push dispatch address high byte", inline=True)
...
comment(0x9AEE, "Set PAGE to &1C00", inline=True)
...
comment(0x924B, "X = A*2 + 2 (skip table header)", inline=True)
...
comment(0x842F, "Shift high nibble into low position", inline=True)
comment(0x8430, "4 shifts total", inline=True)
comment(0x8431, "4th shift", inline=True)
...
comment(0x8B3A, "Shift sector address right", inline=True)
comment(0x8B3B, "To get buffer page offset", inline=True)
...
comment(0x935C, "Point to dir name at &9A5F", inline=True)
...
comment(0xB0F1, "Get buffer offset low", inline=True)
comment(0xB0F4, "Add PTR mid-low to get buffer addr", inline=True)
comment(0xB0F7, "Store buffer address low", inline=True)
comment(0xB0FA, "Get buffer offset mid", inline=True)
comment(0xB0FD, "Add PTR mid-high", inline=True)
comment(0xB100, "Store buffer address mid", inline=True)
comment(0xB103, "Get buffer base page", inline=True)
comment(0xB106, "Add PTR high", inline=True)
comment(0xB109, "Store buffer address high", inline=True)
