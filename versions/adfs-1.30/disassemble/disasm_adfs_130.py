...
d.comment(0xBA5B, 'Bits 0-4 must be clear: only drives 0 and 1', align=Align.INLINE)
d.comment(0xBA5D, 'Clear: a valid drive, carry on', align=Align.INLINE)
d.comment(0xBA65, 'Bit 6 set: not a drive this ROM can reach', align=Align.INLINE)
d.comment(0xBA6A, 'Bit 5: is it drive 1?', align=Align.INLINE)
...
d.comment(0xBF08, 'Bits 0-4 must be clear: only drives 0 and 1', align=Align.INLINE)
d.comment(0xBF0A, 'Clear: a valid drive, carry on', align=Align.INLINE)
d.comment(0xBF0C, 'Non-zero: bad drive error', align=Align.INLINE)
d.comment(0xBF0F, 'Test bit 6 of the drive byte', align=Align.INLINE)
d.comment(0xBF11, 'Clear: reachable drive, select it', align=Align.INLINE)
...
d.comment(0xBA67, 'Yes: bad drive error', align=Align.INLINE)
